...
- SpringBoot2.6.*+Swagger3.0.0接口列表不显示解决方案

相关配置如下：

```java
package com.zjm.common.config;


import com.zjm.common.constant.CommonConstant;
...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    public Docket defaultApi2() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.zjm.web.controller"))
